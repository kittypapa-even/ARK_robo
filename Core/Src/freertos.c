...
extern void chassis(void const * argument);
extern void arm(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(remote_task, remotetask, osPriorityNormal, 0, 1024);
  ...
  osThreadDef(arm_task, arm, osPriorityNormal, 0, 512);
